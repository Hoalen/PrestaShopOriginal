<?php
	...
	switch ($action) {
		case ACTION_READ:
            ...
            error_log("presta_export_oratio2.php > ACTION READ");
		...
		case ACTION_READ_LIST:
            ...
            error_log("presta_export_oratio2.php > ACTION READ LIST");
		...
		case ACTION_CREATE:
            ...
            error_log("presta_export_oratio2.php > ACTION CREATE");
            ...
            while ($order = Db::getInstance()->nextRow($res)) {
                ...
                while ($duedate = Db::getInstance()->nextRow($res_ech)) {
					$result .=	"<duedate coupon_name=\"".utf8_encode($duedate['coupon_name'])."\" netamount=\"".$duedate['netamount']."\" amount=\"".$duedate['amount']."\" />";
				}
				$result .=	"</duedates>";
                ...
                //				error_log(json_encode(array($OrderId => array('shipto'=>$shipto))));
                    error_log(stripslashes($shipto['nom']));
                    //$shipto['nom'] = stripslashes($shipto['nom']);//"Johann L'Écolier";
                    //$shipto['nom'] = "Alberto22 L'Écolier";
                ...
                while ($invoiceto = Db::getInstance()->nextRow($res6b)) {
                    //$invoiceto['nom'] = stripslashes($invoiceto['nom']);//"Johann L'Écolier";
                    //$invoiceto['nom'] = "Alberto22 L'Écolier";
		...
		case UPDATE_ORDER:
            ...
            error_log("presta_export_oratio2.php > UPDATE ORDER");
